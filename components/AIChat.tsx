  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (errorMessage.includes("credentials not configured")) {
        setConfigError("Thirdweb AI is not configured. Please add your THIRDWEB_SECRET_KEY to .env.local");
      }
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900">Thirdweb AI Assistant</h2>
            ...
            {messages.map((message) => (
              ...
              >
                ...
                >
                  ...
                  >
                    {message.role === "user" ? (
                      <FiUser className="text-white cursor-pointer" size={16} />
                    ) : (
                      <FiCpu className="text-white cursor-pointer" size={16} />
                    )}
                  </div>
                  <div
              ...
              <div className="flex justify-start">
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-br from-purple-500 to-blue-600 flex items-center justify-center">
                    <FiLoader className="text-white animate-spin" size={16} />
                  </div>
